...
class Episode:
    def __init__(self, goal, env, max_history_timesteps):
        ...
        # Numpy Array which are used to feed the network directly
        self._history = []
    ...
    def add_step(self, action, obs, reward, achieved_goal, terminal = False):
        ...
        # If thei history is empty, initialize it with the dims of the action and state provided as arguments
        if self._history == []:
