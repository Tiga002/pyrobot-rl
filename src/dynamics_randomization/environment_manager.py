...
class RandomizedEnvironment:
    ...
    def sample_env(self):
        ...
        self._env.set_property('shoulder_link', 'body_mass', shoulder_link_mass*random.uniform(0.25,0.5))
        # Elbow link
        elbow_link_mass = self._env.get_property('elbow_link', 'body_mass')
        self._env.set_property('elbow_link', 'body_mass', elbow_link_mass*random.uniform(0.25,0.5))
        # Forearm link
        forearm_link_mass = self._env.get_property('forearm_link', 'body_mass')
        self._env.set_property('forearm_link', 'body_mass', forearm_link_mass*random.uniform(0.25,0.5))
        # Wrist link
        wrist_link_mass = self._env.get_property('wrist_link', 'body_mass')
        self._env.set_property('wrist_link', 'body_mass', wrist_link_mass*random.uniform(0.25,0.5))
        # Gripper link
        gripper_link_mass = self._env.get_property('gripper_link', 'body_mass')
        self._env.set_property('gripper_link', 'body_mass', gripper_link_mass*random.uniform(0.25,0.5))
        # Finger R link
        finger_r_mass = self._env.get_property('finger_r', 'body_mass')
        self._env.set_property('finger_r', 'body_mass', finger_r_mass*random.uniform(0.25,0.5))
        # Finger L link
        finger_l_mass = self._env.get_property('finger_l', 'body_mass')
        self._env.set_property('finger_l', 'body_mass', finger_l_mass*random.uniform(0.25,0.5))

        # Joint Damping
        joint_1_damping = self._env.get_property('joint_1', 'dof_damping')
        self._env.set_property('joint_1', 'dof_damping', joint_1_damping*random.uniform(0.5,1))
        joint_2_damping = self._env.get_property('joint_2', 'dof_damping')
        self._env.set_property('joint_2', 'dof_damping', joint_2_damping*random.uniform(0.5,1))
        joint_3_damping = self._env.get_property('joint_3', 'dof_damping')
        self._env.set_property('joint_3', 'dof_damping', joint_3_damping*random.uniform(0.5,1))
        joint_4_damping = self._env.get_property('joint_4', 'dof_damping')
        self._env.set_property('joint_4', 'dof_damping', joint_4_damping*random.uniform(0.5,1))
        joint_5_damping = self._env.get_property('joint_5', 'dof_damping')
        self._env.set_property('joint_5', 'dof_damping', joint_5_damping*random.uniform(0.5,1))
        ...
        joint_1_gain[0] = joint_1_gain[0]*random.uniform(0.5,1)
        ...
        joint_2_gain[0] = joint_2_gain[0]*random.uniform(0.5,1)
        ...
        joint_3_gain[0] = joint_3_gain[0]*random.uniform(0.5,1)
        ...
        joint_4_gain[0] = joint_4_gain[0]*random.uniform(0.5,1)
